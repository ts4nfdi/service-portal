...
const Editor = dynamic<EditorProps>(
  ...
  {
    ssr: false,
    loading: () => <div className="text-editor-loading" aria-hidden="true" />,
  },
    ...
    <>
      ...
      <div onClick={onModalClick}>
        <Editor
          ...
          wrapperClassName={
            props.wrapperClassName ?? "" + " text-editor-wrapper"
          }
...
export function highlightEditorIsEmpty() {
  (
    document.getElementsByClassName("rdw-editor-wrapper")[0] as HTMLElement
  ).style.borderColor = "#445669";
}

export function isTextEditorEmpty() {
  let hiddenValue = (
    document.getElementById("hidden-input")! as HTMLInputElement
  ).value;
