...
export function InfoAlertCmp(props: { title: string, body: string }) {
    return (
        <div className="bg-[rgb(197,247,168)] border-t-4 rounded-b text-teal-900 px-4 py-3 shadow-md mb-4 dark:text-black" role="alert">
            <div className="flex">
                <div className="py-1">
                ...
                <div>
                    <p className="font-bold dark:text-black">{props.title}</p>
                    <p dangerouslySetInnerHTML={{ __html: props.body }} className="text-sm dark:text-black"></p>
                </div>
            </div>
        </div>
    );
        ...
        return (
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                    stroke="currentColor" className="md:size-5 size-4">
