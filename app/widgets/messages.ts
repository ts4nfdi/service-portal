export const widgetMessages = {
  ...
  de: {
    ...
    alertBody: `Das Projekt Terminologie-Service-Suite, abgeleitet aus dem
        <a href="https://semanticlookup.zbmed.de/" target="_blank">SemLookP</a>-Projekt und
        jetzt auf GitHub unter dem
        <a href="https://github.com/ts4nfdi" target="_blank">TS4NFDI</a>-Repository gehostet,
