...
export class PortalSource {
    ...
    constructor(sourceData: Source = {}) {
        this._type = sourceData.type ?? "";
        this._url = sourceData.url ?? "";
        this._name = sourceData.name ?? "";
        this._searchUrl = sourceData.searchUrl ?? "";
        this._artefactsUrl = sourceData.artefactsUrl ?? "";
        this._description = "";
        this._contactUrl = "";
        this._title = "";
        this._bartocUrl = "";
    ...
    static toObject(data: PortalSourcesJsonData): PortalSource {
        let pdb = new PortalSource();
        pdb.type = data.type;
        pdb.url = data.url;
        pdb.name = data.name;
