...
export default function CollectionContentCmp(props: {
  ...
  function downloadCollectionJsonData() {
    ...
    const filenameBase =
      props.collection.label || props.collection.id || "collection";
  ...
  return (
    <>
      <div className="mb-4 flex flex-row flex-wrap items-center gap-2">
        <p className="text-3xl font-bold inline-block">
      ...
      <div className="grid grid-cols-10" key={"collection-card-header"}>
        <div className="col-span-9 flex flex-col flex-wrap gap-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-1">
              ...
              >
                ...
                <p key={"collection-id"} className="inline-block  text-sm">
                  {props.collection.id}
                </p>
                <CopyToClipboard
                  textToCopy={props.collection.id!}
                  key={"copy"}
                />
              </div>
            </div>
          ...
          {props.collection.description && (
            <p
              key={"collection-desc"}
              className="bg-gray-100 p-4 dark:bg-gray-700 dark:!text-white"
            >
              {props.collection.description}
            </p>
          )}
